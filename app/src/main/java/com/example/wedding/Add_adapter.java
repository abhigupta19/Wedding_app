...
public class Add_adapter extends BaseAdapter {
    ...
    Add_adapter(Context context, ArrayList<String> contacts, ArrayList<String> nameBy)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View view1=LayoutInflater.from(context).inflate(R.layout.add_adapter,viewGroup,false);
        TextView textView=view1.findViewById(R.id.text);
        CheckBox checkBox=view1.findViewById(R.id.checkbox);

      if(ListprofileContact.b.contains(i))
