...
public class ContactAdapter extends BaseAdapter {
    ...
    ContactAdapter(Context context, ArrayList<String>  contacts,ArrayList<String> nameBy)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View view1=LayoutInflater.from(context).inflate(R.layout.listitem,viewGroup,false);
